	...
	if pane == ultraPanePreview {
		variants = [][]keysSegment{
			...
			},
			{
				...
				{label: "scroll", kind: keysText},
				{label: " | ", kind: keysSep},
				{label: "^d/^u ", kind: keysKey},
				{label: "page", kind: keysText},
				{label: " | ", kind: keysSep},
				{label: "Tab ", kind: keysKey},
				{label: "switch", kind: keysText},
				{label: " | ", kind: keysSep},
				{label: "q ", kind: keysKey},
				{label: "quit", kind: keysText},
			},
			{
				{label: "[U-PREVIEW]", kind: keysLabel},
				{label: " j/k ", kind: keysKey},
				{label: "scr", kind: keysText},
				{label: " | ", kind: keysSep},
				{label: "^d/^u ", kind: keysKey},
				{label: "pg", kind: keysText},
				{label: " | ", kind: keysSep},
				{label: "Tab ", kind: keysKey},
				{label: "sw", kind: keysText},
				{label: " | ", kind: keysSep},
				{label: "q ", kind: keysKey},
				{label: "quit", kind: keysText},
			},
		...
		variants = [][]keysSegment{
			...
			},
			{
				{label: "[U-TREE]", kind: keysLabel},
				{label: " j/k ", kind: keysKey},
				{label: "mv", kind: keysText},
				{label: " | ", kind: keysSep},
				{label: "g/G ", kind: keysKey},
				{label: "edge", kind: keysText},
				{label: " | ", kind: keysSep},
				{label: "z/Z ", kind: keysKey},
				{label: "fd", kind: keysText},
				{label: " | ", kind: keysSep},
				{label: "Tab ", kind: keysKey},
				{label: "sw", kind: keysText},
				{label: " | ", kind: keysSep},
